...
procedure TFsustancia.BtnCanelarClick(Sender: TObject);
begin
 datos.qSustancia.cancelUpdates;
          datos.Data.Rollback;
          ...
          datos.qsustancia.Close;
end;

procedure TFsustancia.btnGuardarClick(Sender: TObject);
begin
...
procedure TFsustancia.btnnuevoClick(Sender: TObject);
begin
  ...
  datos.qSustancia.Open;
  datos.qSustancia.Append;

  DBEdit2.SetFocus;
end;

procedure TFsustancia.btnsalirClick(Sender: TObject);
begin
Close;
end;

procedure TFsustancia.cxGrid2DBTableView1DblClick(Sender: TObject);
begin




   with datos.qSustancia do
    begin
      close;
      sql.Clear;
...
procedure TFsustancia.edtBuscarChange(Sender: TObject);
begin
 with qconsulta1 do
    begin
      close;
...
procedure TFsustancia.FormClose(Sender: TObject; var Action: TCloseAction);
begin
Fsustancia := nil;
action := caFree;
end;

procedure TFsustancia.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFsustancia.FormShow(Sender: TObject);
begin
pnlBuscar.Visible := false;
qConsulta1.Close;
end;

procedure TFsustancia.SpeedButton1Click(Sender: TObject);
begin
