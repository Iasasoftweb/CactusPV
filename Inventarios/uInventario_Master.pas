...
procedure TfInventario_Master.cxGrid2DBTableView1KeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  with Almacenes1 do
  begin
...
begin
  ...
  begin
    ...
    Crear_Mensages('Error', 'Error Número de registro',
      'Suplicacion en número de articulos, favor llamar al Soporte Técnico',
...
begin
  ...
  begin
    Crear_Mensages('Error', 'Operación no permitida',
