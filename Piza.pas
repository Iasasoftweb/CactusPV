...
uses
  ...
  dxBarBuiltInMenu, CurvyControls, System.ImageList, frxExportPDF;
...
type
  TFrmPizza = class(TForm)
    ...
    DetalleFacturasLINEA: TFloatField;
    Panel17: TPanel;
    PanelLTOP: TPanel;
    Image1: TImage;
    Panel3: TPanel;
...
procedure TFrmPizza.adddetalle;
VAR
SUMA : CURRENCY;
itbs : currency;
Stexto : string;
...
procedure TFrmPizza.imprimirtikectCredito;
...
procedure TFrmPizza.altoKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmPizza.anchoKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      if key = vk_return then
    begin
...
procedure TFrmPizza.B2Click(Sender: TObject);
begin
...
procedure TFrmPizza.B6Click(Sender: TObject);
begin
...
procedure TFrmPizza.barra1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
  var
  iResult : integer;
...
procedure TFrmPizza.barraKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
  var
  iResult : integer;
...
procedure TFrmPizza.CurrencyEdit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmPizza.cxButton10Click(Sender: TObject);
begin
...
procedure TFrmPizza.cxButton12Click(Sender: TObject);
begin
if datos.ZdetalleTOTAL.Value >= 0.00 then begin
...
procedure TFrmPizza.cxButton13Click(Sender: TObject);
...
procedure TFrmPizza.cxButton14Click(Sender: TObject);
begin
panel8.Visible := true;
memo.SetFocus;
end;

procedure TFrmPizza.cxButton15Click(Sender: TObject);
begin
panel8.Visible := false;
end;

procedure TFrmPizza.cxButton16Click(Sender: TObject);
begin
memo.Clear;
panel8.Visible := false;
...
procedure TFrmPizza.cxButton17Click(Sender: TObject);
var cont, numpag,i: integer;
      arq:textfile;
      fechaFA : tdate;
      horaFA : ttime;
...
procedure TFrmPizza.cxButton18Click(Sender: TObject);
var cont, numpag,i: integer;
      arq:textfile;
      fechaFA : tdate;
      horaFA : ttime;
...
procedure TFrmPizza.cxButton19Click(Sender: TObject);
var cont, numpag,i: integer;
      arq:textfile;
      fechaFA : tdate;
      horaFA : ttime;
...
procedure TFrmPizza.cxButton1Click(Sender: TObject);
begin
...
procedure TFrmPizza.cxButton20Click(Sender: TObject);
begin
   PanelOpenD.Visible := true;
   edit18.Visible := true;
end;

procedure TFrmPizza.cxButton21Click(Sender: TObject);
begin
...
procedure TFrmPizza.cxButton22Click(Sender: TObject);
var
...
procedure TFrmPizza.cxButton5Click(Sender: TObject);
begin
if FrmHold = nil then
  begin
...
procedure TFrmPizza.B4Click(Sender: TObject);
begin
...
procedure TFrmPizza.B1Click(Sender: TObject);
var
cero : string;
SUMA : CURRENCY;
itbs : currency;
...
procedure TFrmPizza.cxButton23Click(Sender: TObject);
 Var
   F:TextFile;
begin
...
procedure TFrmPizza.cxButton24Click(Sender: TObject);
var
suma, itbs : currency;
begin
...
procedure TFrmPizza.cxButton25Click(Sender: TObject);
var
suma, itbs : currency;
begin
...
procedure TFrmPizza.cxButton26Click(Sender: TObject);
var
suma, itbs : currency;
begin
//dfgfgfgdfg
...
procedure TFrmPizza.cxButton27Click(Sender: TObject);
var
suma, itbs : currency;
begin
...
procedure TFrmPizza.cxButton28Click(Sender: TObject);
begin
...
procedure TFrmPizza.cxButton29Click(Sender: TObject);
begin
if FAutorizacion.ShowModal = mrOk then
           begin
...
procedure TFrmPizza.BtnPrintConduceClick(Sender: TObject);
begin
...
procedure TFrmPizza.cxButton31Click(Sender: TObject);
var
cInf : String;
begin
...
procedure TFrmPizza.cxButton32Click(Sender: TObject);
begin
...
procedure TFrmPizza.cxButton33Click(Sender: TObject);
begin
 calcdescuento;
end;

procedure TFrmPizza.cxButton35Click(Sender: TObject);
begin
...
procedure TFrmPizza.cxButton36Click(Sender: TObject);
begin
...
procedure TFrmPizza.cxButton37Click(Sender: TObject);
begin
...
procedure TFrmPizza.cxButton38Click(Sender: TObject);
begin
...
procedure TFrmPizza.cxButton39Click(Sender: TObject);
begin
ShellExecute(Handle, 'open', 'Calc.exe', nil, nil, SW_SHOWNORMAL);
end;

procedure TFrmPizza.xxxxxxClick(Sender: TObject);
begin
if frmDGII = nil then
  begin
...
procedure TFrmPizza.BtnConduceClick(Sender: TObject);
begin
...
procedure TFrmPizza.b3Click(Sender: TObject);
begin
...
procedure TFrmPizza.cxButton40Click(Sender: TObject);
var
cero : string;
SUMA : CURRENCY;
itbs : currency;
...
procedure TFrmPizza.cxButton41Click(Sender: TObject);
begin
	if FAutorizacion.ShowModal = mrOk then
           begin
...
procedure TFrmPizza.cxButton42Click(Sender: TObject);
begin
if FrmServicioInstalador = nil then
  begin
       FrmServicioInstalador := tFrmServicioInstalador.create(self);
...
procedure TFrmPizza.cxButton4Click(Sender: TObject);
begin
with facturasIMPRESAS do
    begin
        Close;
...
procedure TFrmPizza.cxButton3Click(Sender: TObject);
var
suma, itbs : currency;
begin
...
procedure TFrmPizza.cxButton6Click(Sender: TObject);
var
cant : double;
ancho1 : double;
alto1 : double;
...
procedure TFrmPizza.cxButton6KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
if key = vk_return then
  begin
...
procedure TFrmPizza.cxButton7Click(Sender: TObject);
var
cero1 : string;
nume : integer;
begin
...
procedure TFrmPizza.cxButton8Click(Sender: TObject);
begin
medico.Open;
...
procedure TFrmPizza.BTArticulosClick(Sender: TObject);
begin
...
procedure TFrmPizza.BTborrarClick(Sender: TObject);
var
...
procedure TFrmPizza.BtBuscarPedidoClick(Sender: TObject);
begin
FrmBuscarPedido.showmodal;
end;

procedure TFrmPizza.BTNotaCClick(Sender: TObject);
begin
...
procedure TFrmPizza.BTpedidoClick(Sender: TObject);
begin
...
procedure TFrmPizza.BTSerialClick(Sender: TObject);
begin
...
procedure TFrmPizza.BTTecnicoClick(Sender: TObject);
begin
panel13.Height := 276;
tecnicos.Open;
end;

procedure TFrmPizza.Button4Click(Sender: TObject);
var
suma, itbs : currency;
begin
...
procedure TFrmPizza.fraccional;
VAR
SUMA : CURRENCY;
itbs : currency;
Stexto : string;
...
calcular.Enabled := false;
  ...
  procedure TFrmPizza.imprimeconduce;
 var cont, numpag,i: integer;
      arq:textfile;
      fechaFA : tdate;
      horaFA : ttime;
...
procedure TFrmPizza.ImprimeCopia;
 var cont, numpag,i: integer;
      arq:textfile;
      fechaFA : tdate;
      horaFA : ttime;
...
procedure TFrmPizza.ImprimeCotiza;
 var cont, numpag,i: integer;
      arq:textfile;
      fechaFA : tdate;
      horaFA : ttime;
...
procedure TFrmPizza.nofraccional_varios;
VAR
SUMA : CURRENCY;
itbs : currency;
Stexto : string;
...
procedure TFrmPizza.OpCuandoClick(Sender: TObject);
begin
...
procedure TFrmPizza.optipoClick(Sender: TObject);
begin
...
procedure TFrmPizza.nofraccional;
VAR
SUMA : CURRENCY;
itbs : currency;
Stexto : string;
...
if edit17.Text <>'' then
   begin
    ...
    datos.Zdetallelinea.Value     := Almacenes1EXISTENCIA.Value;
...
procedure TFrmPizza.calcdescuento;
var
suma, itbs :currency;
begin
...
procedure TFrmPizza.calcularClick(Sender: TObject);
begin
panel1.Visible := true;
edit6.Text := '1';
edit6.SetFocus;
...
procedure TFrmPizza.ç(Sender: TObject);
begin
ibqclientes.Close;
ibqclientes.Open;
...
procedure TFrmPizza.cerrarClick(Sender: TObject);
begin
datos.FbqMaster_Fact.Close;
datos.Zdetalle.Close;
IbqClientes.Close;
...
procedure TFrmPizza.ChkPrecio1Click(Sender: TObject);
begin
t3.SetFocus;
end;

procedure TFrmPizza.cxButton9Click(Sender: TObject);
VAR
SUMA : CURRENCY;
itbs : currency;
Stexto : string;
...
procedure TFrmPizza.ChkPrecioClick(Sender: TObject);
begin
...
procedure TFrmPizza.CHKPropertiesChange(Sender: TObject);
begin
...
procedure TFrmPizza.cxComboBox1PropertiesChange(Sender: TObject);
begin
{
...
procedure TFrmPizza.cxDBCalcEdit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
if key = vk_escape then
  begin
...
procedure TFrmPizza.cxDBCalcEdit2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
if key = vk_escape then
  begin
...
procedure TFrmPizza.cxDBCalcEdit3KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
if key = vk_escape then
  begin
...
procedure TFrmPizza.cxDBCalcEdit4KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
if key = vk_escape then
  begin
...
procedure TFrmPizza.cxDBComboBox1PropertiesChange(Sender: TObject);
begin
...
procedure TFrmPizza.cxDBTextEdit4KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
if key = vk_return then
  begin
...
procedure TFrmPizza.cxDBTextEdit5KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
if key = vk_return then
  begin
...
procedure TFrmPizza.cxDBTextEdit6PropertiesChange(Sender: TObject);
begin
...
procedure TFrmPizza.cxGrid1DBTableView1Column2PropertiesButtonClick(
...
procedure TFrmPizza.cxGrid1DBTableView1CustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
var
  ARec: TRect;
...
procedure TFrmPizza.cxGrid1DBTableView1DblClick(Sender: TObject);
begin
...
procedure TFrmPizza.cxGrid1DBTableView1TOTALGetDataText(
  Sender: TcxCustomGridTableItem; ARecordIndex: Integer; var AText: string);
begin
...
procedure TFrmPizza.cxGrid2DBTableView1CellClick(
...
procedure TFrmPizza.cxGrid2DBTableView1Column2CustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
 var
BM : TBitMap;
...
procedure TFrmPizza.cxGrid2DBTableView1CustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
var
  ARec: TRect;
...
procedure TFrmPizza.cxGrid2DBTableView1DblClick(Sender: TObject);
var
SeparadaPorComas :string;
   n                :integer;
   CANTV : STRING;
...
procedure TFrmPizza.cxGrid2DBTableView1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var
SeparadaPorComas :string;
   n                :integer;
...
procedure TFrmPizza.cxGrid4DBTableView1DblClick(Sender: TObject);
begin
tecnico :=  StrToInt(TecnicosCOD_EMP.Value);
...
procedure TFrmPizza.cxGrid7DBTableView1DblClick(Sender: TObject);
begin
datos.FbqMaster_Fact.Edit;
...
procedure TFrmPizza.cxGrid9DBTableView1DblClick(Sender: TObject);
begin
    ...
    with ibqrarticulos do
              begin
                ...
                sql.Add(' a.costo_pr, a.beneficios, a.TIENECOMPACTIBILIDAD,  a.mayoreo1, a.mayoreo2, a.mayoreo3, a.ubicacion from mtartuculos a ');
                sql.Add('where a.codigobarra =:PPP');
                sql.Add('group by a.unidad,a.precio_a, a.precio_b, a.comision, a.precio_d, a.referencia, a.codigobarra, a.cod_art,a.articulo,a.cod_cat,a.politica,a.modelo,a.marca,a.codigotxt,a.itbis,a.taza_compra, ');
                sql.Add('a.costo_pr, a.beneficios, a.TIENECOMPACTIBILIDAD, a.mayoreo1, a.mayoreo2, a.mayoreo3, a.ubicacion,a.OBS');
...
procedure TFrmPizza.PartiGridDBTableView1DblClick(Sender: TObject);
var
suma, itbs, descc : currency;
...
procedure TFrmPizza.PartiGridDBTableView1KeyDown(Sender: TObject;
...
procedure TFrmPizza.Precio_variosKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
  VAR
SUMA : CURRENCY;
itbs : currency;
...
procedure TFrmPizza.PrintCopia;
 var cont, numpag,i: integer;
      arq:textfile;
      fechaFA : tdate;
      horaFA : ttime;
...
procedure TFrmPizza.cxGridDBTableView1DblClick(Sender: TObject);
begin
...
procedure TFrmPizza.cxGridDBTableView1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
//if key = vk_return then
//  begin
...
procedure TFrmPizza.cxGridDBTableView2DblClick(Sender: TObject);
begin
...
procedure TFrmPizza.cxGridDBTableView3DblClick(Sender: TObject);
begin
detallefacturas.Close;
...
procedure TFrmPizza.cxGridDBTableView4DblClick(Sender: TObject);
begin
datos.Zdetalle.Edit;
datos.zdetalleidalmacen.value := almacenesid.Value;
...
procedure TFrmPizza.cxGridDBTableView4KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
if key = vk_return then
  begin
...
procedure TFrmPizza.cxTextEdit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
if key = vk_return then
begin
...
procedure TFrmPizza.cxTextEdit2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var
  Numero: String;
  Valor: Extended;
...
procedure TFrmPizza.cxTextEdit2PropertiesChange(Sender: TObject);
var
  Numero: String;
  Valor: Extended;
  codoriginal : string;
...
procedure TFrmPizza.DBGrid1ColEnter(Sender: TObject);
begin
 t4.Value := datos.ZdetallePRECIO.Value + (datos.ZdetalleITBS.Value / datos.ZdetalleCANTIDAD.Value);
end;

procedure TFrmPizza.DBGrid1ColExit(Sender: TObject);
var
...
procedure TFrmPizza.descKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
        if key = vk_return then
       begin
...
procedure TFrmPizza.EdClaveKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
//if KEY = VK_ESCAPE then
//  BEGIN
...
procedure TFrmPizza.Edit13KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin                         
if key = vk_return then
  begin
...
procedure TFrmPizza.Edit18KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if key = VK_RETURN then begin
       cxButton23.Click;
...
procedure TFrmPizza.Edit19Change(Sender: TObject);
VAR
CODORIGINAL : string;
BuscarSerie : String;
Cantv :String;
...
procedure TFrmPizza.Edit19KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var
T : String;
 SeparadaPorComas :string;
...
procedure TFrmPizza.Edit1Change(Sender: TObject);
begin
...
procedure TFrmPizza.Edit21KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
  var
suma, itbs : currency;
begin
...
procedure TFrmPizza.Edit2Change(Sender: TObject);
begin
...
procedure TFrmPizza.Edit6KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
if key = vk_return then
  begin
...
procedure TFrmPizza.Edit7KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
if key= vk_return then
  begin
...
procedure TFrmPizza.FormClose(Sender: TObject; var Action: TCloseAction);
begin
FrmNFact_normal := nil;
end;

procedure TFrmPizza.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
     var
cero : string;
...
procedure TFrmPizza.FormShow(Sender: TObject);
begin
...
procedure TFrmPizza.Label41Click(Sender: TObject);
begin
...
procedure TFrmPizza.Label49Click(Sender: TObject);
begin
      costoMsn.Visible :=false;
end;

procedure TFrmPizza.Memo2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
if key = vk_escape then
  begin
...
procedure TFrmPizza.RxDBComboBox1Change(Sender: TObject);
begin
if cxDBTextEdit4.Text ='' then
   begin
...
procedure TFrmPizza.RxDBComboBox2Change(Sender: TObject);
begin
...
procedure TFrmPizza.RxDBComboBox2PropertiesChange(Sender: TObject);
var
cero1 : string;
nume : integer;
begin
...
procedure TFrmPizza.t1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmPizza.t3KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
  var
 ...
 if key = vk_return then
    begin
        ...
        if datos.ZUconfiguracionEXISTENCIAFACT.Value = 2 then
           begin
               if strtofloat(t3.Text) > datos.ZdetalleLINEA.Value then
                  begin
...
procedure TFrmPizza.t4Exit(Sender: TObject);
begin
{
...
procedure TFrmPizza.t4KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
if key = vk_return then
  begin
...
procedure TFrmPizza.tDesc1Change(Sender: TObject);
begin
    cxButton33.SetFocus;
end;
